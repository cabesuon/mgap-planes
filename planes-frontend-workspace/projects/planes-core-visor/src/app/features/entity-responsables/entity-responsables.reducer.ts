...
export function entityResponsablesReducer(
  ...
  switch (action.type) {
    // load
    case EntityResponsablesActionTypes.ENTITYRESPONSABLES_PROPIETARIO_LOAD_REQUEST:
    case EntityResponsablesActionTypes.ENTITYRESPONSABLES_ARRENDATARIO_LOAD_REQUEST: {
      return {
        ...state,
        isLoading: true,
        error: null
