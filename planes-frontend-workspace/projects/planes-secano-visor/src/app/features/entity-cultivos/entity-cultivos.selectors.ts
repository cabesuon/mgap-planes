...
export const getIsLoading = (state: EntityCultivosState): boolean => state.isLoading;
...
export const selectAllEntityCultivos: (
  state:object
) => CultivoSecano[] = entityCultivosAdapter.getSelectors(selectEntityCultivosState).selectAll;