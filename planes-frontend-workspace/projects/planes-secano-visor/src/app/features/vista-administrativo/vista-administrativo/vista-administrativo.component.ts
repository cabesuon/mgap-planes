...
export class VistaAdministrativoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    ).subscribe((sources: { planes: PlanSecano[]; chacras: ChacraSecano[];
      personas: PersonaCore[]; empresas: EmpresaCore[]; ingenieros: IngenieroAgronomoCore[]; responsables: ResponsableSecano[];
      rotaciones: RotacionSecano[]; componentes: ComponenteSecano[]; cultivos: CultivoSecano[]; manejos: ManejoSecano[]; rendimientos: RendimientoSecano[] }) => {
