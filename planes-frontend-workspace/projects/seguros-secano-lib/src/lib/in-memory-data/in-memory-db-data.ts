...
export function createInMemoryDataDefault(): InMemoryDbData {
  ...
  const aseguradoras: AseguradoraSegurosSecano[] = [
    ...
    { aseguradoraId: '4', aseguradoraNombre: 'SURCO' },
    { aseguradoraId: '5', aseguradoraNombre: 'SANCOR' }
  ];

  const cultivos: CultivoSegurosSecano[] = [
    { cultivoId: '1', cultivoNombre: 'Barbecho', cultivoCicloId: ['1','2','3'], cultivoEstacionId: 'VERANO' },
    { cultivoId: '2', cultivoNombre: 'Cebada', cultivoCicloId: ['1','2','3'], cultivoEstacionId: 'INVIERNO' },
    { cultivoId: '3', cultivoNombre: 'Cobertura', cultivoCicloId: ['1','2','3'], cultivoEstacionId: 'VERANO' },
    { cultivoId: '4', cultivoNombre: 'Maíz', cultivoCicloId: ['1','3'], cultivoEstacionId: 'VERANO' },
    { cultivoId: '5', cultivoNombre: 'Soja', cultivoCicloId: ['1','2','3'], cultivoEstacionId: 'VERANO' },
    { cultivoId: '6', cultivoNombre: 'Trigo', cultivoCicloId: ['1','2','3'], cultivoEstacionId: 'INVIERNO' }
  ];
