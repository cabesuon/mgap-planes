...
export * from './planes-core/planes-core-table.model';
export * from './planes-core/planes-core-detail.model';
...
export * from './ingenieros-agronomos-core/ingenieros-agronomos-core-detail.model';

export * from './contacto-core/contacto-core.model';
export * from './contacto-core/contacto-core-detail.model';

export * from './empresas-core/empresas-core.model';
export * from './empresas-core/empresas-core-detail.model';
